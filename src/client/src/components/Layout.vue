<template>
  <div class="flex flex-col">
    <div class="nav">
      <nav
        class="bg-white fixed w-screen border-gray-200 dark:bg-gray-900 z-20"
      >
        <div
          ...
          >
            ...
            >
              ...
              <a href="">
                <!-- <% if current_user.avatar.attached? %>
                      <%= image_tag current_user.avatar, class:"h-10 w-10 rounded-full", alt:"profile-pic" %>
                      <% end %> -->
              </a>
            </button>
            <!-- Dropdown menu -->
            ...
            >
              ...
              <svg
                class="w-5 h-5"
                aria-hidden="true"
                xmlns="https://i.pinimg.com/originals/b6/6d/22/b66d22a8b57900e75cbab27192cd58a3.jpg"
                fill="none"
                viewBox="0 0 17 14"
              >
                <path
            ...
            >
              ...
              <li>
                <a
                  ...
                  >Log out</a
                >
                <!-- <%= button_to "Log out", destroy_user_session_path, method: :delete,class:"block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" %> -->
              </li>
            </ul>
          </div>
          <!-- <% end %> -->
    ...
    <div class="footer">
      <footer class="bg-gray-50 dark:bg-gray-800 antialiased pt-8">
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
          ...
          <div class="text-center">
            ...
            <span
              ...
              >© 2023-2024 <a href="#" class="hover:underline">Code-Crafted</a>.
              All Rights Reserved.
            </span>
