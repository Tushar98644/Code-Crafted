      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <p class="text-sm font-light text-gray-500 dark:text-gray-400">
            ...
            <a
              href="/user/signin"
              class="ml-28 font-medium text-primary-600 hover:underline dark:text-primary-500"
              >Login here</a
            >
          </p>
        </div>
    ...
    async signup() {
      try {
        ...
        },
        {
          ...
          console.log(`The signup was successful: ${ response}`);
        ...
        // Handle signup error
        console.error(`There was error while signing up: ${error}`);
      }
    },
  },
};
